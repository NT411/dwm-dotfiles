...
const char *battery_perc_auto(const char *);
...
/* netspeeds */
void netspeed_begin_sample(void);
...
/* updates */
const char *updates(const char *interval);
...
/* volume */
extern volatile sig_atomic_t volume_refresh;
const char *vol_pipewire(const char *unused);
