...
![Example picture](../../../../Images/micro/example.jpg?raw=true "Example")

The repository installer deploys this plugin to `~/.config/micro/plug/filemanager/`. For a separate Micro installation, run `plugin install filemanager` in Micro’s command bar and restart Micro.
...
Expanded directories show `-` to the left; collapsed directories show `+`.
...
| :------- | :------------------------- | :------------------------------------------------------------------------------------------ | :------------------------------------ |
| `tree`   | <kbd>Ctrl-b</kbd>          | Open/close the tree                                                                         | `filemanager.toggle_tree`             |
