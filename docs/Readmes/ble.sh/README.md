...
This script is provided under the [**BSD License**](../../../config/ble.sh/LICENSE.md) (3-clause BSD license).
...
- <sup><a id="discl-make" href="#discl-make">†3</a></sup>Q. *Why does `ble.sh`
  ...
  [`make/README.md`](https://github.com/akinomyoga/ble.sh/blob/master/make/README.md).
